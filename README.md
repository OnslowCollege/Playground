...
5. Finally, click on the Publish Branch (first time you commit to a branch) or Sync Changes/Push button.

### Help, it's not working!

- If you clicked commit and a new tab opens up entitled `COMMIT_EDITMSG`, this means you forgot to add a message (step 2). You can type a commit message into the tab, then save (Ctrl/Cmd-S) to continue committing.
...
1. **IMPORTANT**: Commit and publish/sync any unsaved changes *before* you continue.
...
2. At the bottom of the window, click on the **Source Control** button (usually next to the trash icon).
3. Click on your previous project's branch name.
